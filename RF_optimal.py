...
if __name__ == '__main__':
        ...
        for est in n_estim:
            # for depth in depth_value:
                ...
                for k, (train, val) in enumerate(kFold):
                    ...
                    val_auc,axis = get_AUC.get_cum_area(val_index, total_prob)
    ...
    #         total_prob[altitude[:, :, 0] == -9999] = -1
    #
    #         # TIF_functions.save_tif(total_prob, "RF2.tif", geotransform, proj)
    #         # train_auc = get_AUC.get_cum_area(landslide_train_index, total_prob)
